...
terraform {
  backend "s3" {
    bucket         = "custom-terraform-state-bucket-123456-18f9130a" # Replace with your S3 bucket name
...
resource "aws_s3_object" "private_key_object" {
  bucket                 = "custom-terraform-state-bucket-123456-1c13b9b9" # Reference existing S3 bucket
